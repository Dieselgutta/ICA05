...
//Henter ut Json data ved hjelp av getData funksjonen, og bruker template pakken for å generere en ny html fil sammen med Json data som returneres til brukeren
